...
export function Harry(props) {
  const { nodes, materials, scene } = useGLTF(`${process.env.PUBLIC_URL}/models/Harry.glb`);
...
// 预加载 GLTF 模型和动画
useGLTF.preload(`${process.env.PUBLIC_URL}/models/Harry.glb`);
